...
def analysis_action(board: BoardInfo, action, color):
    ...
    if is_enemy(x+1, y + 0) and is_enemy(x+2, y) and is_empty(x+3, y) and is_enemy(x+4, y):
        weight += 1000000000000
    if is_enemy(x-1, y + 0) and is_enemy(x-2, y) and is_empty(x-3, y) and is_enemy(x-4, y):
        weight += 1000000000000
    if is_enemy(x+0, y+ 1) and is_enemy(x+0, y+2) and is_empty(x+0, y+3) and is_enemy(x+0, y+4):
        weight += 1000000000000
    if is_enemy(x+0, y- 1) and is_enemy(x+0, y-2) and is_empty(x+0, y-3) and is_enemy(x+0, y-4):
        weight += 1000000000000
    if is_enemy(x+1, y+ 1) and is_enemy(x+2, y+2) and is_empty(x+3, y+3) and is_enemy(x+4, y+4):
        weight += 1000000000000
    if is_enemy(x-1, y- 1) and is_enemy(x-2, y-2) and is_empty(x-3, y-3) and is_enemy(x-4, y-4):
        weight += 1000000000000
    if is_enemy(x+1, y- 1) and is_enemy(x+2, y-2) and is_empty(x+3, y-3) and is_enemy(x+4, y-4):
    ...
    if is_enemy(x+1, y + 0) and is_enemy(x+2, y) and is_enemy(x+3, y):
        weight += 1000000000000
    if is_enemy(x-1, y + 0) and is_enemy(x-2, y) and is_enemy(x-3, y):
        weight += 1000000000000
    if is_enemy(x+0, y+ 1) and is_enemy(x+0, y+2) and is_enemy(x+0, y+3):
        weight += 1000000000000
    if is_enemy(x+0, y- 1) and is_enemy(x+0, y-2) and is_enemy(x+0, y-3):
        weight += 1000000000000
    if is_enemy(x+1, y+ 1) and is_enemy(x+2, y+2) and is_enemy(x+3, y+3):
        weight += 1000000000000
    if is_enemy(x-1, y- 1) and is_enemy(x-2, y-2) and is_enemy(x-3, y-3):
       weight += 1000000000000
    if is_enemy(x+1, y- 1) and is_enemy(x+2, y-2) and is_enemy(x+3, y-3):
    ...
    if is_our(x+1, y + 0) and is_our(x+2, y) and is_our(x+3, y) and is_our(x+4, y):
        weight += 10000000
    if is_our(x-1, y + 0) and is_our(x-2, y) and is_our(x-3, y) and is_our(x-4, y):
        weight += 10000000
    if is_our(x+0, y+ 1) and is_our(x+0, y+2) and is_our(x+0, y+3) and is_our(x+0, y+4):
        weight += 10000000
    if is_our(x+0, y- 1) and is_our(x+0, y-2) and is_our(x+0, y-3) and is_our(x+0, y-4):
        weight += 10000000
    if is_our(x+1, y+ 1) and is_our(x+2, y+2) and is_our(x+3, y+3) and is_our(x+4, y+4):
        weight += 10000000
    if is_our(x-1, y- 1) and is_our(x-2, y-2) and is_our(x-3, y-3) and is_our(x-4, y-4):
        weight += 10000000
    if is_our(x+1, y- 1) and is_our(x+2, y-2) and is_our(x+3, y-3) and is_our(x+4, y-4):
    ...
    if is_our(x+1, y + 0) and is_our(x+2, y) and is_our(x+3, y):
        weight += 10000000
    if is_our(x-1, y + 0) and is_our(x-2, y) and is_our(x-3, y):
        weight += 1000000000000
    if is_our(x+0, y+ 1) and is_our(x+0, y+2) and is_our(x+0, y+3):
        weight += 1000000000000
    if is_our(x+0, y- 1) and is_our(x+0, y-2) and is_our(x+0, y-3):
        weight += 1000000000000
    if is_our(x+1, y+ 1) and is_our(x+2, y+2) and is_our(x+3, y+3):
        weight += 1000000000000
    if is_our(x-1, y- 1) and is_our(x-2, y-2) and is_our(x-3, y-3):
       weight += 1000000000000
    if is_our(x+1, y- 1) and is_our(x+2, y-2) and is_our(x+3, y-3):
